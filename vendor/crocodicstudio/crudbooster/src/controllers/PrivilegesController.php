...
class PrivilegesController extends CBController
{
    public function cbInit()
    {
        ...
        $this->form = [];
        $this->form[] = ["label" => "Nome do Privilégio", "name" => "name", 'required' => true, 'validation' => 'required|string|max:190|unique:cms_privileges,name'];
        $this->form[] = ["label" => "Configurar como Superadmin", "name" => "is_superadmin", 'required' => true, 'validation' => 'required|boolean'];
    }
