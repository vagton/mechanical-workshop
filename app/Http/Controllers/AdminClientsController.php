...
class AdminClientsController extends CBController
{
	...
	public function cbInit()
	{
		...
		$this->form[] = ['label' => 'CPF', 'name' => 'cpf', 'type' => 'text', 'validation' => 'required|cpf|unique:clients,cpf', 'width' => 'col-sm-10'];
		...
		# OLD START FORM
		//$this->form = [];
		//$this->form[] = ['label'=>'Nome','name'=>'name','type'=>'text','validation'=>'required|alpha_spaces|min:3|max:190','width'=>'col-sm-10'];
		//$this->form[] = ['label'=>'CPF','name'=>'cpf','type'=>'text','validation'=>'required|cpf|unique:clients,cpf|min:1|max:190','width'=>'col-sm-10'];
		//$this->form[] = ['label'=>'Telefone','name'=>'phone','type'=>'text','validation'=>'required|min:10|max:11','width'=>'col-sm-10'];
		//$this->form[] = ['label'=>'CEP','name'=>'cep','type'=>'text','validation'=>'string|size:8','width'=>'col-sm-10'];
		//$this->form[] = ['label'=>'Endereço','name'=>'address','type'=>'text','validation'=>'string|min:1|max:190','width'=>'col-sm-10'];
		//$this->form[] = ['label'=>'Nº de Endereço','name'=>'address_number','type'=>'text','validation'=>'string|min:1|max:9','width'=>'col-sm-10'];
		//$this->form[] = ['label'=>'Complemento','name'=>'complement','type'=>'text','validation'=>'string|min:1|max:80','width'=>'col-sm-10'];
