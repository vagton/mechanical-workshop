        ...
        <div class="col-sm-12">
            ...
            <div id='panel-form-{{$name}}' class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class='row'>
                        <div class='col-sm-12'>
                            <div class="panel panel-default">
                                <div class="panel-heading"><i class="fa fa-pencil-square-o"></i> Adicionar</div>
                                    ...
                                    @push('bottom')
                                        <script type="text/javascript">
                                            ...
                                            function editRow{{$name}}(t) {
                                                ...
                                                currentRow = p;
                                                p.addClass('warning');
                                                $('#btn-add-table-{{$name}}').val('Alterar');
                                                @foreach($form['columns'] as $c)
                                                @if($c['type']=='select')
                                            ...
                                            function addToTable{{$name}}() {
                                                ...
                                                $('#btn-add-table-{{$name}}').val('Adicionar');
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class='fa fa-table'></i> Detalhes
                        </div>
