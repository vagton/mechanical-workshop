...
<!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
    ...
    <style type="text/css">
        ...
        .login-box-body {
            ...
            color: {{ CRUDBooster::getSetting("login_font_color")?:'#999' }}  !important;
        }
...
<div class="login-box">
    <div class="login-logo">
        <a href="{{url('/')}}">
            <img title='{!!(Session::get('appname') == 'CRUDBooster')?"<b>Oficina</b>Mecânica":CRUDBooster::getSetting('appname')!!}'
    ...
    <div class="login-box-body">
        ...
        <form autocomplete='off' action="{{ route('postLogin') }}" method="post">
            ...
            <div class="form-group has-feedback">
                <input autocomplete='off' type="text" class="form-control" name='email' required placeholder="E-mail"/>
